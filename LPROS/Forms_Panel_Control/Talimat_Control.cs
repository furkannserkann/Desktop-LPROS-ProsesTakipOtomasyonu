    ...
    public partial class Talimat_Control : Form
    {
        ...
        private void SearchTalimat()
        {
            if (!_SearchTalimatClear)
            {
                ...
                Items.panelTalimat.dataGridUst.DataSource = Sc.GET_DATATABLE(SqlConnector.TableTalimat + " and talimat_kodu like '%'+@parametre1+'%' and talimat_adi like '%'+@parametre2+'%'", new String[] { _Kod, _Isim });
